...
export default function PViewAddedBooks() {
                                        ...
                                        {arr && arr.map((data, i) => (
                                            ...
                                            <tr className="table_row" key={i}>
                                                ...
                                                <td className="column-5">
                                                    <button type='button' style={{widh:"100px"}} onClick={()=>{navigate(`/PViewBookDetails/${data?.bookdata?._id}`)}}  className="flex-c-m stext-101 cl0 size-10 bg1 bor1 hov-btn1 p-lr-15 ">
                                                    Order Details
                                                    </button>
                                                </td>
                                                }
