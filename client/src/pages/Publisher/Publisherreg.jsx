...
export default function Publisherreg() {
...
const vaidation=(e)=>{
  ...
  if(contacts.username==="") {
    ...
    console.log(contacts);
    axios.post("http://localhost:5000/register/publisher-register",contacts)
  .then((response) => {
            ...
            {/* <div className="signup-image">
                ...
                <h2 className="form-title">Sign up</h2>
                    ...
                    <div className="form-group">
                        ...
                        <input type="multiple" name="address" id="city" placeholder="Your address" value={contacts.address} onChange={handleInputChange}/>
                        {errorcity?<span className='errormsg'>Please Enter address</span>:null}
                    </div>
                    <div className="form-group">
